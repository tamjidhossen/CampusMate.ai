  ...
  const volunteers = [
    {
      ...
      profilePic: 'https://images.unsplash.com/photo-1494790108755-2616b612b212?w=64&h=64&fit=crop&crop=face',
      score: 2850,
      responsesCount: 47,
      completedRequests: 42,
      joinDate: new Date('2024-09-15'),
      specialties: ['Emergency Response', 'Medical Assistance', 'Blood Donation'],
      contact: {
        phone: '+1 (555) 123-4567',
        email: 'sarah.chen@university.edu'
      },
      achievements: ['Top Volunteer 2024', 'Emergency Response Expert', 'Community Hero'],
    ...
    },
    {
      ...
      profilePic: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=64&h=64&fit=crop&crop=face',
      score: 2650,
      responsesCount: 38,
    ...
    },
    {
      ...
      profilePic: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=64&h=64&fit=crop&crop=face',
      score: 2400,
      responsesCount: 34,
      ...
      achievements: ['Compassionate Helper', 'Mental Health Advocate', 'Peer Counselor'],
    ...
    },
    {
      ...
      profilePic: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=64&h=64&fit=crop&crop=face',
      score: 2200,
      responsesCount: 29,
    ...
    },
    {
      ...
      profilePic: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=64&h=64&fit=crop&crop=face',
      score: 1950,
      responsesCount: 25,
      completedRequests: 22,
      joinDate: new Date('2024-11-10'),
      specialties: ['Event Organization', 'Administrative Help', 'Student Services'],
      contact: {
    ...
    },
    {
      ...
      profilePic: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=64&h=64&fit=crop&crop=face',
      score: 1800,
      responsesCount: 22,
    ...
    <div className="h-full flex flex-col bg-gray-950/30">
      ...
      <div className="p-6 border-b border-gray-700">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="text-2xl font-bold text-white">Volunteer Leaderboard</h1>
            <p className="text-gray-400 text-sm mt-1">Recognizing our most helpful community members</p>
          </div>
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="bg-gray-800/50 rounded-lg p-3 text-center">
            <div className="text-lg font-bold text-white">{volunteers.length}</div>
            <div className="text-xs text-gray-400">Active Volunteers</div>
          </div>
          <div className="bg-gray-800/50 rounded-lg p-3 text-center">
            <div className="text-lg font-bold text-orange-400">{volunteers.reduce((sum, v) => sum + v.responsesCount, 0)}</div>
            <div className="text-xs text-gray-400">Total Responses</div>
          </div>
          <div className="bg-gray-800/50 rounded-lg p-3 text-center">
            <div className="text-lg font-bold text-green-400">{volunteers.reduce((sum, v) => sum + v.completedRequests, 0)}</div>
            ...
            return (
              <motion.div
                ...
                className={`bg-gray-800/80 border rounded-xl p-4 transition-all duration-200 hover:border-gray-600 hover:bg-gray-800 cursor-pointer ${
                  rank <= 3 ? 'border-orange-500/30 bg-orange-500/5' : 'border-gray-700'
                }`}
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <div className={`text-xs mt-1 font-medium ${scoreGrade.color}`}>
                      {scoreGrade.grade}
                    </div>
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center space-x-2 mb-1">
                      <h3 className="font-semibold text-white truncate">{volunteer.name}</h3>
                      {rank <= 3 && (
                  ...
                  <div className="text-right">
                    <div className="text-lg font-bold text-white mb-1">{volunteer.score.toLocaleString()}</div>
                    ...
                    <div className="flex items-center space-x-4 mt-2 text-xs text-gray-500">
                      ...
                      <div className="flex items-center space-x-1">
                        ...
                        <span>{Math.round((volunteer.completedRequests / volunteer.responsesCount) * 100)}%</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-white">Volunteer Profile</h2>
                <button
                  onClick={() => setShowProfileModal(false)}
              ...
              <div className="space-y-6">
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-400">{selectedVolunteer.department}</p>
                  
                  {/* Score Grade */}
                  <div className={`inline-flex items-center space-x-2 mt-2 px-3 py-1 rounded-full bg-gray-900 border border-gray-600`}>
                    <Trophy className="w-4 h-4 text-orange-500" />
                    <span className="text-white font-medium">{selectedVolunteer.score.toLocaleString()} points</span>
                    <span className={`font-bold ${getScoreGrade(selectedVolunteer.score).color}`}>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gray-900 rounded-lg p-4 text-center">
                    <div className="text-2xl font-bold text-orange-400 mb-1">{selectedVolunteer.responsesCount}</div>
                    <div className="text-xs text-gray-400">Total Responses</div>
                  </div>
                  <div className="bg-gray-900 rounded-lg p-4 text-center">
                    <div className="text-2xl font-bold text-green-400 mb-1">{selectedVolunteer.completedRequests}</div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center space-x-3 text-gray-300">
                      ...
                      <span className="break-all">{selectedVolunteer.contact.email}</span>
                    </div>
                    <div className="flex items-center space-x-3 text-gray-300">
                ...
                <div className="bg-gray-900 rounded-lg p-4">
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <div className="text-white">{formatJoinDate(selectedVolunteer.joinDate)}</div>
                    </div>
                    <div>
                      <div className="text-gray-400 mb-1">Success Rate</div>
                      <div className="text-white">
                        {Math.round((selectedVolunteer.completedRequests / selectedVolunteer.responsesCount) * 100)}%
                      </div>
                    </div>
                  </div>
                </div>
